        ...
        {tab === "node" ? (
          <div style={{ display: "flex", gap: 18, flexWrap: "wrap" }}>
            <div className="plate" style={{ width: 262, padding: 16, flexShrink: 0 }}>
              ...
              <Field label="Inscribed circle diameter" unit="m" value={p.icd} min={10} max={140} step={0.5} onChange={set("icd")} />
              <Field label="Circulatory roadway width" unit="m" value={p.w} min={4.5} max={16} step={0.25} onChange={set("w")} />
              ...
              <div className="plate" style={{ padding: "10px 12px", marginTop: 14 }}>
                ...
                <div style={{ display: "flex", gap: 14, alignItems: "center", flexWrap: "wrap" }}>
                  <svg width={PW} height={PW} viewBox={`0 0 ${PW} ${PW}`} style={{ flexShrink: 0 }}>
                    <circle cx={PW / 2} cy={PW / 2} r={(p.icd / 2 + p.setback) * pk} fill="none" stroke={RULE} strokeWidth="0.7" strokeDasharray="4 4" />
                    <circle cx={PW / 2} cy={PW / 2} r={(p.icd / 2) * pk} fill={MAG} fillOpacity="0.12" stroke={MAG} strokeWidth="0.8" />
                    <circle cx={PW / 2} cy={PW / 2} r={(r.islandD / 2) * pk} fill={FILM2} stroke={MAG} strokeWidth="0.8" />
